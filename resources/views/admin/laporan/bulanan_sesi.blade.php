                        ...
                        <table class="min-w-full divide-y divide-gray-200 border">
                            <thead class="bg-gray-50">
                                <tr>
                                    ...
                                    <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">Total Sesi Wajib</th>
                                    <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">Sesi Hadir</th>
                                    <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">Sesi Terlambat</th>
                                    ...
                                    <th class="px-4 py-3 text-center text-xs font-medium text-gray-500 uppercase">% Kehadiran Sesi</th>
