           ...
           <div class="mb-6">
                <div class="sm:hidden">
                    ...
                    <select id="tabs" name="tabs" class="block w-full rounded-md border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" onchange="window.location.href = this.value;">
                        <option value="{{ route('admin.laporan.bulanan', request()->query()) }}" selected>Tampilan Harian</option>
                        <option value="{{ route('admin.laporan.bulanan.sesi', request()->query()) }}">Tampilan per Jadwal</option>
                    </select>
                </div>
