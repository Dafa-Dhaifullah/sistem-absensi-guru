<x-admin-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Import Data Pengguna dari Excel') }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    @if (session('import_errors'))
                        <div class="mb-4 p-4 bg-red-100 border border-red-400 text-red-700 rounded-md">
                            <p class="font-bold">Gagal mengimpor beberapa data:</p>
                    ...
                    <form action="{{ route('admin.pengguna.import.excel') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div>
                        ...
                        <div class="flex items-center gap-4 mt-6">
                            ...
                            <a href="{{ route('admin.pengguna.index') }}" class="text-gray-600 hover:text-gray-900">{{ __('Batal') }}</a>
                        </div>
                    </form>
                </div>
            </div>
