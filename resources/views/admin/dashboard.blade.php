            ...
            <div class="bg-white p-6 rounded-xl shadow-sm">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <a href="{{ route('admin.pengguna.index', ['role' => 'piket']) }}" class="group flex items-center gap-4 p-4 bg-slate-50 rounded-lg hover:bg-yellow-50 transition">
                             <div class="flex-shrink-0 bg-yellow-100 p-3 rounded-lg"><svg class="h-6 w-6 text-yellow-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" /></svg></div>
                            <div>
                                <div class="font-semibold text-gray-800 group-hover:text-yellow-800">Data Guru Piket</div>
                                <p class="text-xs text-gray-500 mt-1">Kelola akun khusus guru piket.</p>
                            </div>
                        </a>
                        <a href="{{ route('admin.pengguna.index', ['role' => 'guru']) }}" class="group flex items-center gap-4 p-4 bg-slate-50 rounded-lg hover:bg-blue-50 transition">
                            ...
                            <div>
                                <div class="font-semibold text-gray-800 group-hover:text-blue-800">Data Guru Umum</div>
