...
<ul class="space-y-1 text-sm">
  ...
  @if($role === 'admin')
    ...
    <li>
    <a href="{{ route('admin.hari-kerja.index') }}" 
       class="group flex items-center gap-3 rounded-lg px-3 py-2 {{ $active('admin.hari-kerja.*')  }}"
       title="Manajemen Hari Kerja">
        ...
        <span class="sidebar__label">Manajemen Hari Kerja</span>
    </a>
</li>
