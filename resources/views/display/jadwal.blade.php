            ...
            <table class="min-w-full">
                ...
                <tbody class="bg-gray-900">
                    @forelse ($jadwalSekarang as $jadwal)
                        @php
                            // REVISI: Cari laporan berdasarkan user->id
                        ...
                        <tr class="border-b border-gray-700 hover:bg-gray-800">
                            ...
                            <!-- REVISI: Panggil relasi 'user' dan kolom 'name' -->
                            <td class="px-6 py-6 whitespace-nowrap text-3xl font-medium">{{ $jadwal->user->name ?? 'N/A' }}</td>
