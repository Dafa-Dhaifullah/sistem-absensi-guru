...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <li>
        @php
            // Tentukan rute dashboard dinamis berdasarkan role
        ...
        @endphp
        <a href="{{ route($dashboardRoute) }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
    ...
    <!-- ============================================== -->
    <!-- == MENU YANG HANYA BISA DILIHAT ADMIN == -->
    <!-- ============================================== -->
    @if(Auth::user()->role == 'admin')
    ...
    <!-- ============================================================== -->
    <!-- == MENU YANG BISA DILIHAT ADMIN & KEPALA SEKOLAH == -->
    <!-- ============================================================== -->
