...
>
    ...
    @if(Auth::user()->role == 'admin')
        ...
        <li>
            <a href="{{ route('admin.pengguna.index') }}" class="group flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-gray-700 {{ request()->routeIs('admin.pengguna.*') && request('role') == 'guru' ? 'sidebar-active' : '' }}" title="Data Guru Umum">
                ...
                <span x-show="!sidebarMini" x-transition>Data Pengguna</span>
            </a>
        </li>
        ...
        <li>
    <a href="{{ route('admin.qrcode.generator.index') }}" class="group flex items-center gap-3 rounded-lg px-3 py-2 hover:bg-gray-700 {{ request()->routeIs('admin.qrcode.*') ? 'sidebar-active' : '' }}" title="Generator QrCode">
    <svg class="w-5 h-5 text-gray-400 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <span x-show="!sidebarMini" x-transition>Generator QrCode</span>
</a>
</li>
    @endif
