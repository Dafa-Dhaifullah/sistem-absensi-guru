    ...
    <body class="font-sans antialiased bg-gray-100">
        ...
        <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
            <div class="h-full px-3 py-4 overflow-y-auto bg-gray-800">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center ps-2.5 mb-5 mt-16"> <span class="self-center text-xl font-semibold whitespace-nowrap text-white">Sistem Absensi Guru</span>
                </a>
                ...
                <ul class="space-y-2 font-medium">
                    ...
                    <li>
                        <a href="{{ route('admin.data-guru.index') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-400 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                <path d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a1 1 0 0 1-1 1H1a1 1 0 0 1-1-1v-2a6.957 6.957 0 0 1 1.264-4H0A1 1 0 0 1 0 9v-1a1 1 0 0 1 1-1h1.264A6.957 6.957 0 0 1 0 3V1a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v2a6.957 6.957 0 0 1-1.264 4H14a1 1 0 0 1 1 1v1a1 1 0 0 1-1 1Zm-5-4q0 .309-.034.616A6.97 6.97 0 0 1 10 9.616v4.768a.998.998 0 0 1-.184 1.616A6.97 6.97 0 0 1 10 16.616v-4.768a.998.998 0 0 1 .184-1.616A6.97 6.97 0 0 1 10 9.616V6.384a.998.998 0 0 1 .184-1.616A6.97 6.97 0 0 1 10 4.384v4.768a.998.998 0 0 1-.184 1.616A6.97 6.97 0 0 1 10 11.384Z"/>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('admin.akun-piket.index') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-400 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 14 18">
                    ...
                    <li>
                        <a href="{{ route('admin.jadwal-pelajaran.index') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-400 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M18 0H2a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2Zm-5.5 4.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6ZM13.929 17H7.071a.5.5 0 0 1-.5-.5 3.935 3.935 0 1 1 7.858 0 .5.5 0 0 1-.5.5Z"/>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('admin.kalender-blok.index') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-400 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V4Zm-2 13H2V7h16v10ZM6 10a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm4 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"/>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('admin.laporan.realtime') }}" class="flex items-center p-2 text-white rounded-lg bg-blue-500 hover:bg-blue-600 group">
                            <svg class="w-5 h-5 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 16">
                                <path d="M19 0H1a1 1 0 0 0-1 1v14a1 1 0 0 0 1 1h18a1 1 0 0 0 1-1V1a1 1 0 0 0-1-1ZM2 13V2h16v11H2Z"/>
                                <path d="M5 14.5a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm3 0a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm11 .5H1a1 1 0 0 1 0-2h18a1 1 0 0 1 0 2Z"/>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('admin.laporan.bulanan') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-400 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M18 16.983V18H2v-1.017C2 15.899 5.59 15 10 15s8 .899 8 1.983ZM10 12a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"/>
                                <path d="M10 0a10 10 0 1 0 0 20 10 10 0 0 0 0-20ZM10 13a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z"/>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('admin.laporan.mingguan') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-400 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm0 18a8 8 0 1 1 0-16 8 8 0 0 1 0 16ZM9 13a1 1 0 0 1-1-1V8a1 1 0 0 1 2 0v4a1 1 0 0 1-1 1Zm1-5a1 1 0 1 1-2 0 1 1 0 0 1 2 0Z"/>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('admin.laporan.individu') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-400 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 0a10 10 0 1 0 10 10A10.011 10.011 0 0 0 10 0Zm-2 5a2 2 0 1 1 4 0 2 2 0 0 1-4 0Zm2 13a7.948 7.948 0 0 1-4.949-1.889A3.99 3.99 0 0 1 9 13h2a3.99 3.99 0 0 1 2.949 1.111A7.948 7.948 0 0 1 12 18Z"/>
                            </svg>
                    ...
                    <li>
                        <a href="{{ route('admin.laporan.arsip') }}" class="flex items-center p-2 text-white rounded-lg hover:bg-gray-700 group">
                            <svg class="w-5 h-5 text-gray-400 transition duration-75 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M19.728 10.686c-2.38 2.256-6.153 4.315-9.728 4.315S2.38 12.942 0 10.686v8.139A1.175 1.175 0 0 0 1.175 20h17.65A1.175 1.175 0 0 0 20 18.825v-8.139Zm-17.65 0c2.38 2.256 6.153 4.315 9.728 4.315s7.348-2.059 9.728-4.315V2.175A1.175 1.175 0 0 0 18.825 1H1.175A1.175 1.175 0 0 0 0 2.175v8.511Z"/>
                            </svg>
        ...
        <div id="main-content" class="sm:ml-64 transition-all duration-300 ease-in-out">
             <main>
                @if (isset($header))
        ...
        <script>
            // Ambil elemen dari ID yang kita buat
            const sidebarToggle = document.querySelector('[data-drawer-toggle="default-sidebar"]');
            const mainContent = document.getElementById('main-content');
            
            if (sidebarToggle && mainContent) {
                // Fungsi untuk mengecek status sidebar
                function checkSidebar() {
                    // Cek apakah sidebar-nya (target dari tombol) sedang terbuka (tidak ada '-translate-x-full')
                    const sidebar = document.getElementById(sidebarToggle.getAttribute('data-drawer-target'));
                    // Cek di layar kecil (mobile)
                ...
                // Jalankan fungsi saat tombol di-klik
                sidebarToggle.addEventListener('click', function() {
                    // Kita beri jeda 50ms agar Flowbite JS selesai menjalankan animasinya
                    setTimeout(checkSidebar, 50); 
                });

                // Cek juga saat halaman di-load (khususnya untuk state desktop)
