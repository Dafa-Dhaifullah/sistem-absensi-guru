...
class MasterJamPelajaranSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $senin = [
            ['hari' => 'Senin', 'jam_ke' => 1, 'jam_mulai' => '07:15', 'jam_selesai' => '08:00'], // <== ISI SESUAI DATA CSV ANDA
            ['hari' => 'Senin', 'jam_ke' => 2, 'jam_mulai' => '08:00', 'jam_selesai' => '08:45'], // <== ISI SESUAI DATA CSV ANDA
            ['hari' => 'Senin', 'jam_ke' => 3, 'jam_mulai' => '08:45', 'jam_selesai' => '09:30'], // <== ISI SESUAI DATA CSV ANDA
            ...
            ['hari' => 'Senin', 'jam_ke' => 10, 'jam_mulai' => '14:50', 'jam_selesai' => '14:35'],
        ];

        // 2. Data Jam Hari SELASA (Asumsi Selasa-Kamis sama)
        // (Jika Selasa, Rabu, Kamis beda semua, buat 3 variabel terpisah)
        $selasa_kamis_tpl = [
            ['jam_ke' => 1, 'jam_mulai' => '06:30', 'jam_selesai' => '07:15'], // <== ISI SESUAI DATA CSV ANDA
            ['jam_ke' => 2, 'jam_mulai' => '07:15', 'jam_selesai' => '08:00'], // <== ISI SESUAI DATA CSV ANDA
            ...
            ['jam_ke' => 10, 'jam_mulai' => '14:05', 'jam_selesai' => '14:50'], // <== ISI SESUAI DATA CSV ANDA
            
        ];

        // 3. Data Jam Hari JUMAT (6 Jam)
        $jumat = [
            ['hari' => 'Jumat', 'jam_ke' => 1, 'jam_mulai' => '06:30', 'jam_selesai' => '07:15'], // <== ISI SESUAI DATA CSV ANDA
            ...
            ['hari' => 'Jumat', 'jam_ke' => 6, 'jam_mulai' => '10:15', 'jam_selesai' => '11:00'], // <== ISI SESUAI DATA CSV ANDA
